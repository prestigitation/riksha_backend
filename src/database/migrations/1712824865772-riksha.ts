...
export class Riksha1712824865772 implements MigrationInterface {
    name = 'Riksha1712824865772'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`discounts\` ADD \`productId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`discountId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD UNIQUE INDEX \`IDX_7fbbfed5cc7852606c3193bf40\` (\`discountId\`)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_7fbbfed5cc7852606c3193bf40\` ON \`products\` (\`discountId\`)`);
        await queryRunner.query(`ALTER TABLE \`discounts\` ADD CONSTRAINT \`FK_515a9b59c4344f0239956c218ac\` FOREIGN KEY (\`productId\`) REFERENCES \`products\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`products\` ADD CONSTRAINT \`FK_7fbbfed5cc7852606c3193bf40a\` FOREIGN KEY (\`discountId\`) REFERENCES \`discounts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`variations\` DROP FOREIGN KEY \`FK_a471ef11612596a4afb19de0f06\``);
        await queryRunner.query(`ALTER TABLE \`products\` DROP FOREIGN KEY \`FK_ff56834e735fa78a15d0cf21926\``);
        await queryRunner.query(`ALTER TABLE \`products\` DROP FOREIGN KEY \`FK_7fbbfed5cc7852606c3193bf40a\``);
        await queryRunner.query(`ALTER TABLE \`tags\` DROP FOREIGN KEY \`FK_1e685539b0827e801e5ac275db2\``);
        await queryRunner.query(`ALTER TABLE \`labels\` DROP FOREIGN KEY \`FK_b1f4a11bf417c729f57893e289f\``);
        await queryRunner.query(`ALTER TABLE \`ingredients\` DROP FOREIGN KEY \`FK_45086227ab44452354335f03876\``);
        await queryRunner.query(`ALTER TABLE \`discounts\` DROP FOREIGN KEY \`FK_515a9b59c4344f0239956c218ac\``);
        await queryRunner.query(`DROP INDEX \`REL_7fbbfed5cc7852606c3193bf40\` ON \`products\``);
        ...
        await queryRunner.query(`ALTER TABLE \`ingredients\` ADD CONSTRAINT \`FK_45086227ab44452354335f03876\` FOREIGN KEY (\`productId\`) REFERENCES \`products\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`products\` DROP INDEX \`IDX_7fbbfed5cc7852606c3193bf40\``);
        await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`discountId\``);
        await queryRunner.query(`ALTER TABLE \`discounts\` DROP COLUMN \`productId\``);
    }
